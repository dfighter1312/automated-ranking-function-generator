...
public class PairwiseAnticorrelated implements InputGenerator{

    final static int HIGH_VARIANCE = 100;
    final static int LOW_VARIANCE = 25;

    final private Random random;
    final private EasyRandom easyRandom;
    private Long seed = null;

    public PairwiseAnticorrelated(){
        random = new Random();
        easyRandom = new EasyRandom();
        
    }

    public PairwiseAnticorrelated(long seed){
        this.seed = seed;
    ...
    private static double[][] getAntiCorr(int num, int a, int b){
